# Top 100 Typescript Interview Questions in 2026
...
| No. | Questions |
| --- | --------- |
| 1 | [What is _TypeScript_ and how does it differ from _JavaScript_?](#1-what-is-_typescript_-and-how-does-it-differ-from-_javascript_) |
| 2 | [Can you explain what is meant by "_TypeScript_ is a _superset_ of _JavaScript_"?](#2-can-you-explain-what-is-meant-by-_typescript_-is-a-_superset_-of-_javascript_) |
| 3 | [What are the _basic types_ available in _TypeScript_?](#3-what-are-the-_basic-types_-available-in-_typescript_) |
| 4 | [How do you declare _variables_ in _TypeScript_?](#4-how-do-you-declare-_variables_-in-_typescript_) |
| 5 | [What are _Interfaces_ in _TypeScript_ and how do they work?](#5-what-are-_interfaces_-in-_typescript_-and-how-do-they-work) |
| 6 | [Describe the _Enum_ type and when you might use it.](#6-describe-the-_enum_-type-and-when-you-might-use-it) |
| 7 | [How do you define and use a _function_ in _TypeScript_?](#7-how-do-you-define-and-use-a-_function_-in-_typescript_) |
| 8 | [What does "_type inference_" mean in the context of _TypeScript_?](#8-what-does-_type-inference_-mean-in-the-context-of-_typescript_) |
| 9 | [Explain the use of '_let_' and '_const_' in _TypeScript_.](#9-explain-the-use-of-_let_-and-_const_-in-_typescript_) |
| 10 | [How do you compile _TypeScript_ files into _JavaScript_?](#10-how-do-you-compile-_typescript_-files-into-_javascript_) |
| 11 | [Explain _classes_ in _TypeScript_. How are they different from _ES6 classes_?](#11-explain-_classes_-in-_typescript_-how-are-they-different-from-_es6-classes_) |
| 12 | [How do you implement _Inheritance_ in _TypeScript_?](#12-how-do-you-implement-_inheritance_-in-_typescript_) |
| 13 | [What are _access modifiers_ and how do they work in _TypeScript_?](#13-what-are-_access-modifiers_-and-how-do-they-work-in-_typescript_) |
| 14 | [Discuss _Abstract classes_ and their purposes in _TypeScript_.](#14-discuss-_abstract-classes_-and-their-purposes-in-_typescript_) |
| 15 | [Can you describe the use of _Constructors_ within _TypeScript classes_?](#15-can-you-describe-the-use-of-_constructors_-within-_typescript-classes_) |
<!-- TOC_END -->
